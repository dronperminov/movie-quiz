...
from src.api import analytics, api, auth, movies, multi_player, persons, questions, quiz_tours, settings, tracks
...
def init_routers() -> None:
    ...
    app.include_router(quiz_tours.router)
    app.include_router(multi_player.router)
